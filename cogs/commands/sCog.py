...
from views import PrononsView, GenreChooseV2View, LastMSGV2View, GenreChooseV3View
...
class sCog(commands.Cog):
    ...
    async def s(self, ctx): 
        ...
        await ctx.send("Choose your genre preferences! Don't see your favs? You can suggest it in <#962242442193670204>.", view=GenreChooseV2View())
        await ctx.send(view=GenreChooseV3View())
